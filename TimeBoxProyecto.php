...
?>
<div id="page-title">
    <h2>Asociación TimeBox-Proyecto</h2>
    <p>Aprovechar</p>
</div>         
<?php
	if(isset($_GET['error']))
							...
							<div class="col-sm-4">
								<div class="input-prepend input-group">
									<select id="cliente" name="cliente" class="form-control" required>
										<option selected value="0">Proyecto Prueba</option>
										<?php
											//$ddl->viewProyecto($proyecto);
										?>
									</select>
								</div>
							</div>
							<label for="" class="col-sm-2 control-label">TimeBoxes</label>
							<div class="col-sm-4">
								<div class="input-prepend input-group">
									<select id="timebox" name="timebox" class="form-control" required>
										<option selected value="0">Selecciona un TimeBox</option>
										<option>Time Box 1</option>
										<option>Time Box 2</option>
										<option>Time Box 3</option>
										<option>Time Box 4</option>
										<option>Time Box 5</option>
										<?php
											//$ddl->viewTimeBoxes();
										?>
									</select>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="bg-default content-box text-center pad20A mrg25T">
							<button id="generar" name="generar" type="button" class="btn btn-lg btn-primary" onclick="getModals();">Ingresar</button>
						</div>
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">
											La informacion será procesada ¿te gustaría confirmar el ingreso de esta relación? Una vez que confirmes, no podras cambiar la información.
									</div>
